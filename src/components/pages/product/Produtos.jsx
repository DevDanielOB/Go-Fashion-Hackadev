              ...
              <div className="product-detail-desc1">
                ...
                <div className="container-size">
                  ...
                  <form className="buttons-size">
                    ...
                    />
                    <label className="label-size" for="PP">
                      PP
                    </label>
                    ...
                    <input
                      ...
                      className="input-size"
                    />
                    <label className="label-size" for="P">
                      P
                    </label>
                    ...
                    <input
                      ...
                      className="input-size"
                    />
                    <label className="label-size" for="M">
                      M
                    </label>
                    ...
                    <input
                      ...
                      className="input-size"
                    />
                    <label className="label-size" for="G">
                      G
                    </label>
                  </form>
                </div>
                ...
                <div className="vestuario">
                  <div>
                    <img className="cabide" src={Cabide} alt="" title="" />
                    <span className="cabide-text">Provador Virtual</span>
                  </div>
                  <div>
                    <img className="metrica" src={Metrica} alt="" title="" />
                    <span className="metrica-text">Tabela de Medidas</span>
                  </div>
                </div>
